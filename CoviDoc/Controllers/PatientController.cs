...
namespace CoviDoc.Controllers
{
    public class PatientController : Controller
    {
        ...
        public async Task<IActionResult> Test(Guid id)
        {
            ...
            DiagnosisReportViewModel patientTestViewModel = new DiagnosisReportViewModel()
            {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Test([Bind("PatientId,TestCentreId,TestStatus")] DiagnosisReportViewModel patientTestViewModel)
        {
            if (ModelState.IsValid)
            {
                try
